...
Hexadecimal [16-Bits]
                     ...
                     0007     7 _entity_size == 7
                     0003     8 max_entities == 3
                              9 
   4000 00                   10 _num_entities::  .db 0
   4001 03 40                11 _last_entity_ptr::  .dw _entity_array 
                             12 
   ...
   4017 AA                    7    .db 0xAA
                             14 
                             15 ;;  --- ENTITY MANAGER INITIALICER  ---
                             16 ;;  Allows restarting the game
                             17 ;;
                             18 ;;  INPUT:  NONE
                             19 ;;  DESTROYS:   AF, HL      
   4018                      20 entity_man_init::
   4018 AF            [ 4]   21     xor     a, a                    ;;reset A 
   4019 32 00 40      [13]   22     ld      (_num_entities),a       ;;set number of entities to 0
                             23 
   401C 21 03 40      [10]   24     ld      hl, #_entity_array      ;;
   401F 22 01 40      [16]   25     ld      (_last_entity_ptr), hl  ;;set the pointer to the fist position
   4022 C9            [10]   26 ret
                             27 
                             28 ;;  --- ENITITY MANAGER NEW ---
                             29 ;;  Creates new entity without values and updates _num_entities and _last_entity_ptr
                             30 ;;  INPUT: NONE
                             31 ;;  DESTROYS:   HL, DE, BC, F
                             32 ;;  RETURNS:
                             33 ;;          HL -> last entity pointer
...
Hexadecimal [16-Bits]
                             ...
                             34 ;;          BC -> enitity size
   4023                      35 entity_man_new::
   4023 21 00 40      [10]   36     ld hl,#_num_entities
   4026 34            [11]   37     inc (hl)                    ;;Increases num_enitities value
                             38 
   4027 2A 01 40      [16]   39     ld hl, (_last_entity_ptr)   ;;HL = last entity mem. position
   402A 54            [ 4]   40     ld d, h                     ;;DE register points to new entitys beginning 
   402B 5D            [ 4]   41     ld e, l                     ;;We cannot exchange DE and HL values because HL is needed later
                             42 
   402C 01 07 00      [10]   43     ld bc, #_entity_size        ;;BC = enitity size
   402F 09            [11]   44     add hl, bc                  ;;
   4030 22 01 40      [16]   45     ld (_last_entity_ptr), hl   ;;Updates _last_entity_ptr
                             46 
   4033 C9            [10]   47 ret
                             48 
                             49 ;;  --- ENTITY MANAGER CREATE
                             50 ;;  INPUT: NONE
                             51 ;;  DESTROYS:   HL, DE, BC, F
                             52 ;;  RETURNS:
                             53 ;;          HL -> last entity pointer
                             54 ;;          BC -> enitity size  
   4034                      55 entity_man_create::
                             56 
   4034 E5            [11]   57     push    hl                  ;;Saves HL
   4035 CD 23 40      [17]   58     call    entity_man_new
                             59 
   0038                      60     ld__ixh_d                  ;;loads D in IX FIRTST 8 bytes   [Non documented]
   4038 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   003A                      61     ld__ixl_e                   ;;loads E in IX LASTS 8 bytes    [Non documented]
   403A DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                             62    
   403C E1            [10]   63     pop     hl
   403D ED B0         [21]   64     ldir   
   403F C9            [10]   65 ret
                             66 ;;Getters
                             67 ;;  Returns:
                             68 ;;          IX -> Pointer to entity array 
                             69 ;;           A -> Total entities
   4040                      70 entity_man_getArray::
   4040 DD 21 03 40   [14]   71     ld ix, #_entity_array
   4044 3A 00 40      [13]   72     ld a, (_num_entities)
   4047 C9            [10]   73 ret
                             74 
